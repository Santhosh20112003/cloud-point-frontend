...
function Invite() {
  ...
  <div class="container px-5 py-24 mx-auto">
	...
	<h1 className="px-8 py-3 mb-5 bg-gray-100  rounded-full text-sm font-bold text-[#8c89fe]">Join With Us </h1>
      <h1 class="sm:text-4xl text-2xl font-semibold title-font mb-4 text-gray-900 break-words">Try it now for an efficient and Secure storage experience!</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-xl">Unlock seamless and secure digital storage with our cloud solution.Access your files anytime,anywhere.elevate your storage experience</p>
