...
function Hero() {
  ...
  <div class="container mx-auto flex px-12 lg:px-12 lg:py-32 pt-24 lg:flex-row flex-col-reverse items-center">
    <div class="lg:flex-grow lg:w-1/2 lg:pr-24 lg:pl-12 flex flex-col lg:items-start lg:text-left mb-16 lg:mb-0 items-center text-center">
      <h1 class="title-font text-[45px] leading-tight font-bold  mb-4  text-gray-900">Elevate Your Business With 
        <br class="block" /><span className=" text-3xl ">Cutting-Edge Cloud Storage Solutions</span>
      </h1>
      <p class="mb-8 w-[80%] leading-relaxed">Elevate your to new heights as you harness as you  harness the power of the cloud. Explore a world of limitless possiblities.</p>
