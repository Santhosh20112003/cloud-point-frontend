...
const Overview = () => {
  ...
  const handleUpload = async (uploadedImg, filename) => {
    try {
      ...
      if (fileType.startsWith("image/") || fileType.startsWith("video/")) {
        const totalSize =
          updatedImgUrl.reduce((acc, file) => acc + file.size, 0) + fileSize;
  ...
  return (
    <div className="w-full relative md:h-screen md:max-h-screen max-h-[90vh] h-[90vh] bg-white md:bg-gray-200 ">
      <header className="w-full h-[10vh] flex items-center justify-between px-5 py-8 bg-[#3897f0]">
              ...
              <Dialog.Portal>
                ...
                <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] h-[90vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                  <div className="w-full h-full block bg-gray-50  px-3 py-2 divide-y-2 overflow-y-scroll">
                    <h1 className="text-xl text-mauve11 text-center w-full py-3 px-2 font-semibold">
                      Your Images
                    </h1>
                          ...
                          item.contentType.startsWith("image/") && (
                            <Dialog.Close asChild>
                              <img
                                ...
                                src={item.url}
                                alt=""
                                className={`w-full brightness-90 rounded-md ${
                                  selectedImage === item.url
                                    ? "border-2 border-white outline outline-[#3897f0]"
                                    : ""
                                }`}
                                onClick={() => {
        ...
        <span className="flex items-center justify-center">
              ...
              <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                ...
                <fieldset className="w-full mt-5 gap-5">
                  <span className="mb-[15px] flex items-center  justify-center">
                    <label
                      className="text-gray-500 mr-3 w-[90px] text-right text-[15px]"
                      htmlFor="name"
                    >
                      File Name
                    </label>
                ...
                <div className="mt-[25px] flex justify-end">
                  ...
                  <Dialog.Close asChild>
                    <button
                      onClick={() => {
                        handleUpload(selectedImage, filename);
                      }}
                      className="bg-[#3897f0] text-white  inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] ml-3 font-medium leading-none focus:shadow-[0_0_0_2px] focus:outline-none"
                    >
                      Save
                    </button>
                  </Dialog.Close>
          ...
          <button
            ...
            className="px-5 ml-3 py-2 active:scale-90 transition-all rounded-full shadow-md bg-gray-200 outline-none border-none"
          >
            Reset
          </button>
        </span>
                      ...
                      >
                        ...
                        <div className="my-10">
                          <div className="flex items-center">
                            ...
                            <label
                              className="text-mauve11 text-lg leading-none pl-[15px]"
                              htmlFor="Grayscale"
                            >
                              Grayscale
                            </label>
