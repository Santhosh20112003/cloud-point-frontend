...
function Login() {
  ...
  return (
    <div className="flex h-[100vh] w-full">
      <Link
        to="/home"
        className="fixed active:scale-105 transition-transform  flex items-center justify-center px-3 py-2.5 top-5 left-5 rounded-full shadow-lg
     bg-[#3b82f6] w-fit h-fit"
      ...
      <div className="flex min-h-[100vh] w-full lg:w-1/2 items-center flex-col justify-center px-6 py-12 lg:px-8 ">
        <span className="rounded-xl lg:border-gray-300 lg:shadow-none shadow-lg lg:border lg:w-[400px] p-5">
          <div className="sm:mx-auto  sm:w-full sm:max-w-sm">
            ...
            <h2 className="text-[#049ce8] text-center text-4xl font-extrabold">
              Enter Your Space
            </h2>

            <h3 className="text-center mt-3 text-md text-gray-400 font-medium">
              Login and Start Using Cloud Point
            </h3>
          </div>
          <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            <div class="flex flex-col my-5 max-w-md space-y-5">
              <button
                disabled={loading}
                onClick={GoogleAuth}
                class="flex disabled:border-blue-300 items-center justify-center flex-none  py-2  rounded-lg border-2 border-gray-300 bg-gray-50 font-medium text-gray-500 gap-5 active:bg-gray-200 active:scale-95 transition-all"
              >
                <img
                  class="w-5 "
                  alt="G"
              ...
              <button
                disabled={loading}
                onClick={GitHubAuth}
                class="flex items-center disabled:border-blue-300 justify-center flex-none  py-2  rounded-lg border-2 border-gray-300 bg-gray-50 font-medium text-gray-500 gap-5 active:bg-gray-200 active:scale-95 transition-all"
              >
                <img
                  class="w-5 "
                  alt="G"
              ...
              >
                <img
                  class="w-5 "
                  alt="G"
                  src="https://ik.imagekit.io/vituepzjm/favicon.ico"
                />
      ...
      <div className="hidden bg-gray-400 overflow-hidden relative lg:block w-1/2 h-full">
        <img
          ...
          alt="banner"
          className="brightness-75 relative w-100 h-full object-cover"
        />
